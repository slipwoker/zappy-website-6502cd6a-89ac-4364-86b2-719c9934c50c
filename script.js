document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    const getErrorMessage = function (field, rule) {
      const messages = {
        required: field.dataset.errorRequired || 'This field is required.',
        email: field.dataset.errorEmail || 'Please enter a valid email address.',
        minLength: field.dataset.errorMinlength || 'This field is too short.',
        phone: field.dataset.errorPhone || 'Please enter a valid phone number.'
      };
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Opium & president משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '6502cd6a-89ac-4364-86b2-719c9934c50c',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '6502cd6a-89ac-4364-86b2-719c9934c50c';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '6502cd6a-89ac-4364-86b2-719c9934c50c';
